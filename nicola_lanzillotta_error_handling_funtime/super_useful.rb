...
def convert_to_int(str)
  begin
    ...
    puts "Cannot conver to Integer. Please ensure you pass a valid numeric string"
  ensure
    num ||= 0
  end
...
class BestFriend
  def initialize(name, yrs_known, fav_pastime)
    ...
    raise ArgumentError.new("'yrs_known' must be greater than or equla to 5 (best friendships take time)") if yrs_known.to_i < 5
